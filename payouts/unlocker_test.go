...
func TestCalculateRewards(t *testing.T) {
	blockReward, _ := new(big.Rat).SetString("400000000000000000")
...
func TestChargeFee(t *testing.T) {
	orig, _ := new(big.Rat).SetString("400000000000000000")
	value, _ := new(big.Rat).SetString("400000000000000000")
	expectedNewValue, _ := new(big.Rat).SetString("375000000000000000")
	expectedFee, _ := new(big.Rat).SetString("125000000000000000")
